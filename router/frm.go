...
func (r *Router) checkNameInvalid(name string) bool {
	// 1. Currently neodb don`t support db/table name like `a/a`, in MySQL, `/` will be converted to `@002f`
	...
	// space will be changed to `@0020f`, we both don`t support in neodb.
