...
func (c *Cleanup) cleanupHandler(database string, backend string) error {
	...
	// 2. Find the table with suffix '_cleanup', check whether exist in neodb. If not, drop table.
	...
	// 3. Find the table with suffix '_migrate', check whether migrating or exist in neodb. If not, drop table.
